...
function Signin() {
  ...
  return (
    <div
      className={`${
        dark ? "!bg-[#1d4bd6aa]" : "!bg-[#05091582]"
      } flex justify-center w-full h-screen items-end sm:items-center`}
    >
      <div
        className={`${
          dark ? "!bg-[#1c1f2e] text-white" : "!bg-[#fff] text-[#000]"
        } p-5 sm:p-12 pb-0 section w-full sm:max-w-2xl bg-[#232634] h-auto mx-auto shadow-lg rounded-t-2xl sm:rounded-2xl`}
      >
        <div className="title">
