...
const StreamAuth = () => {
  ...
  return (
    <div
      className={`flex justify-center w-full h-screen items-end sm:items-center ${
        dark ? "bg-[#212534]" : ""
      }`}
    >
      <div className="p-5 sm:p-12 pb-0 section w-full sm:max-w-2xl bg-[#232634] h-auto mx-auto shadow-lg rounded-t-2xl sm:rounded-2xl">
        <Title order={3} size="h1" align="center" className="pb-8">
          ...
          <div className="w-full">
            <Button
              ...
              style={{
                ...
                backgroundImage:
                  "linear-gradient(45deg, rgb(76, 110, 245) 0%, rgb(21, 170, 191) 100%)",
              }}
            >
              {isSignup ? "Sign Up" : "Sign In"}
            </Button>
        ...
        <div className="flex justify-between items-center">
          ...
          <p>
            ...
            <span
              className="text-[#83bbff] m-10 mr-0 cursor-pointer"
              onClick={switchMode}
            >
