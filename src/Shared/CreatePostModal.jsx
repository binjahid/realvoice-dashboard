    ...
    <Fragment>
      ...
      >
        <div
          ...
          } w-full md:w-[60%] lg:w-[40%] overflow-y-auto !bg-[#1c1f2e] rounded-t-xl relative sm:!rounded-xl p-3 `}
        >
          <div
            onClick={() => setPostOpen(!open)}
            className="text-2xl cursor-pointer absolute top-[5px] right-[5px] rounded-full"
          >
            <AiOutlineClose />
          </div>
