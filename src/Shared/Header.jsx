  ...
  return (
    <header
      className={`p-3 hidden ${
        dark
          ? "!bg-[rgb(28,31,46)] border-[#3f445d]"
          : "bg-white zoomla-border-clr"
      } sm:block !z-20 fixed !bottom-0 !left-0 sm:inset-0 max-w-[90px] border-r`}
    >
      ...
      <nav className="mt-20">
        <ul>
            ...
            <NavLink to="/" end={true}>
              {({ isActive }) => (
                <span
                  className={
                    isActive
                      ? "menu-item isActive light:text-white"
                      : "menu-item"
                  }
                >
                  <BsHouseDoorFill className="m-auto" />
                </span>
              )}
            </NavLink>
          </li>
          <li>
            <NavLink to="/chat">
              {({ isActive }) => (
                <span className={isActive ? "menu-item isActive" : "menu-item"}>
                  <BsChatLeftDots />
                </span>
              )}
            </NavLink>
