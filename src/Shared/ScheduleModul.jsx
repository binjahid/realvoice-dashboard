  ...
  return (
    <>
      ...
      >
        <div
          className={`${
            dark ? "!bg-[#1c1f2e] text-[#fff]" : "!bg-[#fff] text-[#000]"
          } w-full md:w-[80%] lg:w-[60%] h-[550px] sm:h-[790px] overflow-y-auto !bg-[#1c1f2e] rounded-t-2xl md:!rounded-2xl p-3 sm:p-6`}
        >
          <form onSubmit={handleSubmit}>
            ...
            <DialogBody
              ...
              } py-6 !px-0 !w-full !block border-y !text-white`}
            >
              ...
              <input
                ...
                className={` ${
                  dark
                    ? "bg-[#282c3a] text-gray-500"
                    : "!bg-[#eff6ff] text-[#0e78f9]"
                } w-full rounded-xl px-5 h-16 focus:border-none focus:outline-none text-xl`}
                value={eventName}
              ...
              <div
                className={`${
                  dark ? "border-[#3f445d]" : "border-[#e8eaf5]"
                } flex justify-between w-full md:border-b border-t md:flex-nowrap flex-wrap `}
              >
                ...
                <div className="w-full md:pl-5 md:border-l border-[#31364d]">
                  <div className="py-5 w-full">
                    ...
                    <select
                      ...
                      className={`${
                        dark
                          ? "bg-[#282c3a] !text-white border-[#3f445d]"
                          : "text-[#000] border-[#e8eaf5]"
                      } border !rounded-xl w-full text-md p-[10px]`}
                    >
                        ...
                        <input
                          ...
                          className={`${
                            dark
                              ? "bg-[#282c3a] !text-white border-[#3f445d]"
                              : "text-[#000] border-[#e8eaf5]"
                          } !rounded-xl mx-auto !w-full border text-sm p-2`}
                          placeholder="08:40"
                          required
                        />
                    ...
                    <div className="my-6">
                      ...
                      <div className="flex items-center justify-between mt-2 gap-x-3">
                        <span
                          className={` ${
                            dark
                              ? "bg-[#282c3a] !text-gray-500 border border-[#2f3449]"
                              : "!bg-[#eff6ff] text-[#0e78f9]"
                          } rounded-[10px] w-full text-sm !px-4 py-[10px] capitalize flex items-center`}
                        >
                          {randomId}
                        </span>
                        <div>
