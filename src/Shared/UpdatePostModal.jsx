  ...
  return (
    <Fragment>
      <Dialog
        ...
        } flex !bg-[#4b69c294] items-center justify-end sm:justify-center !w-full`}
        size="xxl"
        open={open}
      ...
      >
        <div
          ...
          } w-full sm:w-[60%] lg:w-[40%] overflow-y-auto !bg-[#1c1f2e] rounded-t-xl relative sm:!rounded-xl p-3`}
        >
          <div
            onClick={() => setUpdatePostOpen(!open)}
            className="text-2xl cursor-pointer absolute top-[5px] right-[5px] rounded-full text-white"
          >
            <AiOutlineClose />
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <input
                  ...
                  } border text-sm !w-[90%] px-4 !py-[8px] rounded-[24px] outline-0`}
                  type="text"
                  value={title}
          ...
          <DialogFooter className="flex justify-between items-center w-full sm:!p-4 !px-0">
            <ul className="flex items-center gap-x-5">
              ...
              >
                <span className="text-[20px] sm:text-[30px] text-blue-700 font-bold">
                  <ImFilePicture />
                </span>
              ...
              <li className="flex items-center">
                <span className="text-[20px] sm:text-[30px] text-[#8e44ad] font-bold">
                  <FaRegFileVideo />
                </span>
