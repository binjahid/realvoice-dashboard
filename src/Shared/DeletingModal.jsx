  ...
  return (
    <Fragment>
      <Dialog
        ...
        } flex !bg-[#4b69c250] items-center justify-end sm:justify-center !w-full`}
        size="xxl"
        open={open}
      ...
      >
        <div
          ...
          } w-full sm:w-[60%] lg:w-[40%] overflow-y-auto !bg-[#1c1f2e] rounded-t-2xl sm:!rounded-2xl p-3 sm:p-6`}
        >
          <LoadingOverlay visible={visible} overlayBlur={2} />
          <DialogHeader className="flex !text-white !px-0 items-center justify-between">
            <h1 className="text-red-500 !text-xl">
              Are you sure You Want Delete This{" "}
              {method === "events" ? "Schedule List" : "Post"}
            </h1>
          </DialogHeader>
